      ...
      <div className="content">
        ...
        <div className="form">
          <div className="form-group">
            ...
            <input type="text" name="name" placeholder="Name" required onChange={handleOnChange} />
          </div>
          <div className="form-group">

            <input type="text" name="address" placeholder="Address" required onChange={handleOnChange} />
          </div>
          <div className="form-group">

            <input type="text" name="phone" placeholder="Phone" required onChange={handleOnChange} />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="email" name="email" placeholder="email" required onChange={handleOnChange} />
          </div>
          <div className="form-group">

            <input type="password" name="password" placeholder="password" required onChange={handleOnChange} />
          </div>
